...
(function () {
    ...
    var _postMessage = (window.parent !== window)
                ...
                for (var m = 0; m < mutations.length; m++) {
                    ...
                    for (var n = 0; n < added.length; n++) {
                        ...
                        if (node.querySelectorAll) {
                            ...
                            for (var ic = 0; ic < inner.length; ic++) attachToCanvas(inner[ic]);
                        }
                    }
                }
            ...
            try {
                ...
                for (var g = 0; g < pads.length; g++) {
                    ...
                    for (var b = 0; b < pads[g].buttons.length; b++) {
                        if (pads[g].buttons[b].pressed) { startInteraction(); return; }
                    }
                    for (var a = 0; a < pads[g].axes.length; a++) {
                        if (Math.abs(pads[g].axes[a]) > 0.5) { startInteraction(); return; }
                    }
                }
            } catch (_) { }
        }, 500);
